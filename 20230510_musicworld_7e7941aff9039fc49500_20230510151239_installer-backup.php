...
namespace {
    ...
    {
        const ARCHIVE_FILENAME   = '20230510_musicworld_7e7941aff9039fc49500_20230510151239_archive.zip';
        const ARCHIVE_SIZE       = '67770684';
        const INSTALLER_DIR_NAME = 'dup-installer';
        const PACKAGE_HASH       = '7e7941a-10151239';
        const SECONDARY_PACKAGE_HASH = '217a553-10151239';
        const VERSION            = '1.5.4';
